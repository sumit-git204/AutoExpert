...
router.get("/user/complaints", userController.getUserComplaints)
router.get("/admin/complaints", checkAdminRole, userController.getAllComplaints)
router.put("/complaints/:id", checkAdminRole, userController.updateComplaintStatus)
